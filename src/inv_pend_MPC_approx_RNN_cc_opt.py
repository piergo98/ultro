...
class InvertedPendulumRNN:
    ...
    def __init__(
        ...
        # Training bounds
        alpha = 0.5
        self.theta_train_bound = alpha * self.theta_bound
        self.omega_train_bound = alpha * self.omega_bound
    ...
    def generate_initial_states(self, generate_informative=False):
        ...
        if generate_informative:
            ...
            extreme_x0 = self.inverted_pend.solve_extreme_x0(N=self.N, plot_results=False)
    ...
    def solve_closed_loop_MPC_for_initial_states(self):
        ...
        self.inverted_pend.define_simple_MPC_control(N=self.N+10)
